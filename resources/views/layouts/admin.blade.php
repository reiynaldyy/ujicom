...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    ...
    <!--  SAMA DENGAN FUNGSI INCLUDE DI PHP, HANYA SAJA PENULISAN DIBLADE MENJADI, BERARTI KITA ME-LOAD FILE LAINNYA -->
    ...
    <div class="app-body" id="dw">
        <div class="sidebar">
      	...
      	<!-- BAGIAN INI AKAN DI-REPLACE SESUAI ISI YANG DIAPIT DARI  -->
        @yield('content')
