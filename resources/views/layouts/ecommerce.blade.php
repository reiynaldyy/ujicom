...
<body class="animsition">
		...
		<div class="container-menu-header">
			...
			<div class="wrap_header">
				...
				<a href="index.html" class="logo">
					<img src="{{asset('assets/fashe/images/icons/logo.png')}}" alt="IMG-LOGO">
				</a>
				...
				<div class="header-icons">
					...
					<div class="header-wrapicon2">
						<img src="{{asset('assets/fashe/images/icons/icon-header-02.png')}}" class="header-icon1 js-show-header-dropdown" alt="ICON">
							...
							<ul class="header-cart-wrapitem">
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="{{asset('assets/fashe/images/item-cart-01.jpg')}}" alt="IMG">
									</div>
								...
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="{{asset('assets/fashe/images/item-cart-02.jpg')}}" alt="IMG">
									</div>
								...
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="{{asset('assets/fashe/images/item-cart-03.jpg')}}" alt="IMG">
									</div>
			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{{asset('assets/fashe/images/banner-02.jpg')}}" alt="IMG-BENNER">
					...
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{{asset('assets/fashe/images/banner-05.jpg')}}" alt="IMG-BENNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{{asset('assets/fashe/images/banner-03.jpg')}}" alt="IMG-BENNER">
					...
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{{asset('assets/fashe/images/banner-07.jpg')}}" alt="IMG-BENNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{{asset('assets/fashe/images/banner-04.jpg')}}" alt="IMG-BENNER">
					...
					<div class="block2 wrap-pic-w pos-relative m-b-30">
						<img src="{{asset('assets/fashe/images/icons/bg-01.jpg')}}" alt="IMG">
			...
			<div class="wrap-slick2">
				<div class="slick2">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								<img src="{{asset('assets/fashe/images/item-02.jpg')}}" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative">
								<img src="{{asset('assets/fashe/images/item-03.jpg')}}" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative">
								<img src="{{asset('assets/fashe/images/item-05.jpg')}}" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
								<img src="{{asset('assets/fashe/images/item-07.jpg')}}" alt="IMG-PRODUCT">
			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
					<div class="hov-img-zoom pos-relative">
						<img src="{{asset('assets/fashe/images/banner-08.jpg')}}" alt="IMG-BANNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
					<div class="bgwhite hov-img-zoom pos-relative p-b-20per-ssm">
						<img src="{{asset('assets/fashe/images/shop-item-09.jpg')}}" alt="IMG-BANNER">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
					...
					<div class="block3">
						<a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
							<img src="{{asset('assets/fashe/images/blog-01.jpg')}}" alt="IMG-BLOG">
						</a>
				...
				<div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
					...
					<div class="block3">
						<a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
							<img src="{{asset('assets/fashe/images/blog-02.jpg')}}" alt="IMG-BLOG">
						</a>
				...
				<div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
					...
					<div class="block3">
						<a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
							<img src="{{asset('assets/fashe/images/blog-03.jpg')}}" alt="IMG-BLOG">
						</a>
	...
	<section class="instagram p-t-20">
		...
		<div class="flex-w">
			...
			<div class="block4 wrap-pic-w">
				<img src="{{asset('assets/fashe/images/gallery-03.jpg')}}" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="{{asset('assets/fashe/images/gallery-07.jpg')}}" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="{{asset('assets/fashe/images/gallery-09.jpg')}}" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="{{asset('assets/fashe/images/gallery-13.jpg')}}" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="{{asset('assets/fashe/images/gallery-15.jpg')}}" alt="IMG-INSTAGRAM">
	...
	<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
		...
		<div class="t-center p-l-15 p-r-15">
			<a href="#">
				<img class="h-size2" src="{{asset('assets/fashe/images/icons/paypal.png')}}" alt="IMG-PAYPAL">
			</a>

			<a href="#">
				<img class="h-size2" src="{{asset('assets/fashe/images/icons/visa.png')}}" alt="IMG-VISA">
			</a>

			<a href="#">
				<img class="h-size2" src="{{asset('assets/fashe/images/icons/mastercard.png')}}" alt="IMG-MASTERCARD">
			</a>

			<a href="#">
				<img class="h-size2" src="{{asset('assets/fashe/images/icons/express.png')}}" alt="IMG-EXPRESS">
			</a>

			<a href="#">
				<img class="h-size2" src="{{asset('assets/fashe/images/icons/discover.png')}}" alt="IMG-DISCOVER">
			</a>
...
<!--===============================================================================================-->
	...
	<script type="text/javascript" src="j{{asset('assets/fashes/slick-custom.js')}}"></script>
<!--===============================================================================================-->
...
<!--===============================================================================================-->
	<script type="text/javascript" src="{{asset('assets/fashe/vendor/sweetalert/sweetalert.min.js')}}"></script>
	<script type="text/javascript">
...
<!--===============================================================================================-->
	<script src="{{asset('assets/fashejs/main.js')}}"></script>
