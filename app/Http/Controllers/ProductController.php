...
class ProductController extends Controller
{
     public function index()
    {
        ...
        //LOAD VIEW INDEX.BLADE.PHP YANG BERADA DIDALAM FOLDER PRODUCT
    ...
    public function create()
{
    ...
    //LOAD VIEW create.blade.php` YANG BERADA DIDALAM FOLDER PRODUCT
...
public function store(Request $request)
{
    ...
    if ($request->hasFile('image')) {
        ...
        //SIMPAN FILENYA KEDALAM FOLDER PUBLIC/PRODUCT, DAN PARAMETER KEDUA ADALAH NAMA CUSTOM UNTUK FILE TERSEBUT
